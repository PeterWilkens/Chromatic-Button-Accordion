...
},
{
  ...
  "number": "5.5",
  "title": "Chord Grips.",
  "body": " Chord Grips.  What is a Grip?  A grip is a seventh chord construction and will include either a major seventh, a minor seventh, or a major sixth interval between the lowest and highest note. Grips are labeled by the interval between their lowest and highest note and the chord quality will be determined by the type of 7th and the type of 3rds within the chord. It may have a Major, a Minor. a Diminished or an Augmented Tonality.  With the exception of the diminished seventh grip, all grips are either major or minor seventh grips.  A grip is primarily made up of four notes.  A single grip can be applied to many various types of chords by adding a different notes in the bass.  By adding an additional note in the bass (or treble) the chord identity and quality is changed.  Using these grips and understanding how the chord changes with different bass additions makes available a vast number of new chords all of which can be played with smooth voice leading.  A number of exercises follow which should help with familiarisation and ear training.   Maj7 Chord. Grip 1 and 1a arranged in a circle of 5ths     Grip 1 and 1a Major 7 progressions     Maj7 5 Grips 2 and 2a Generated by lowering the 5th of the chord in the previous Grip 1 and 1a (Maj7) by a semitone. Note that a slightly modified grip is used when the chord is based on column 1 of the accordion.    Grip 1 and 1A Maj7Flat5's in circle of 5ths progressions    "
},
{
...
{
  "id": "sec-chord-grips-8",
  "level": "2",
  "url": "sec-chord-grips.html#sec-chord-grips-8",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "grips "
