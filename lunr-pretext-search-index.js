...
},
{
  ...
  "body": " Authors' Introduction   This Manual describes the C System Chromatic Button Accordion with both Stradella and Free Bass.  The manual will focus primarily on chord and scale construction on both treble and free bass.  I was particularly drawn to the button accordion (rather than the piano accordion); noting that Chord and Scale construction on this type of keyboard allow the use of moveable shapes specific to different Chord and Scale Types. That shape may be moved anywhere on the keyboard giving a chord or scale identified by the Tonic in the shape.  This use of fingerboard shapes is similar to the way in which different Chords and Scales are represented in many resources used by Guitar Players, removing the need to read music whilst still being able to learn about Scale and Chord construction. The main scales and chord types (in various inversions) will be considered.   "
},
{
