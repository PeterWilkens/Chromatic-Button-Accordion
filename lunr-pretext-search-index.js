...
},
{
  ...
  "number": "3.3.2",
  "title": "",
  "body": " Figure showing Intervals and Interval Quality between the notes in a Major Scale    A Major scale is defined by the type of interval between the different degrees of the scale with all Major Scales having the same Interval structure as shown here. Thus specific Major scales can be built using any note as a tonic and applying the same interval structure.   "
},
{
