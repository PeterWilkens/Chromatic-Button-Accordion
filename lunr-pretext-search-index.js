...
},
{
  ...
  "body": " The Circle of Fifths  The Circle of Fifths is useful in understanding musical concepts far beyond showing the different Key Signatures.  I will try and to demonstrate what the Circle of Fifths is and how to use it to properly benefit from all that it offers.  The The Circle of Fifths can be confusing. It is important to realise that you can progress round the circle clockwise or anticlockwise. It is also important to appreciate that the pitch may be ascending or descending as progress is made round the circle in either direction.  The Circle of Fifths:    Is just a diagram showing the 12 musical Keys laid out in a circular format.  The notes are written such that, if travelling round the circle in a clockwise direction, and they are ascending in pitch they are separated by an Interval of a Perfect 5th.   If travelling in an anticlockwise direction and the notes are ascending in pitch, they are separated by an Interval of a Perfect 4th .  If travelling in a clockwise direction and the notes are descending in pitch, they are separated by an Interval of a Perfect 4th .  If travelling in an anticlockwise direction and the notes are descending in pitch, they are seperated by an Interval of a Perfect 5th .  You can see from the above, that the Circle could be legitimately called The Circle of Fourths and sometimes is. It all depends on direction of travel and ascending or falling pitch.  With C at the 12 O'Clock position, C has no Accidentals in its' Key Signature, going clockwise G has 1 , D has 2 s, A has 3 s and so on.  From C going anticlockwise F has 1 , B has 2 s, E has 3 s etc;  The Relative Minor is shown on an inner circle opposite its' Relative Major, eg; A Minor is at the 12 O'clock position opposie to C Major.      Diagram showing key elements of the circle of fifths    Access important Chord Progressions Using The Circle of Fifths:    By adding a Chord Qualifier to each Pitch identity on the Circle some of the most important Chord Progressions, used in all types of music, can be obtained by using the Circle Diagram.  For this purpose all movement through the Circle will be Counterclockwise.  Direction of travel Chordwise will therefore be C to F to B to E and so on using the \"pitch labels\" in the Circle.  Figure 4.0.2 shows one of the more important chord resolutions in music.  Figure 4.0.3 illustrates all the possible ii-V-I progressions.Probable the most frequently occurring progression in all modern music.  Figure 4.0.0 illustrates all the Dominants of Dominants, another frequently used chordal device.  iii-VI7-ii-V7-I eg; C mi\/F7\/B mi\/E 7 \/A Maj7  All these progressions cycle in an anticlockwise direction through the same Root note sequence (allbeit with different Chord Qualities).      Diagram showing important V7 to VI progression.      Diagram showing ii-V7-I Progression      Diagram showing V7 to V7 Progression    "
},
{
